  ...
  return (
    ...
    >
      ...
      <div css={shippingDescriptionCSS}>
        ...
        cannot be changed after you have placed an order. Please note, an order
        cannot be cancelled or modified once it has been placed.
        <h3>SHIPPING OPTIONS:</h3>
        FREE STANDARD SHIPPING OVER $40 $3.99 below $40 (12-15 business days)
        <h3>RETURNS</h3>
        Free in-store returns Return with USPS ($5.99) H&M HOME items purchased
        online must be returned by mail
      </div>
    </section>
  );
}
